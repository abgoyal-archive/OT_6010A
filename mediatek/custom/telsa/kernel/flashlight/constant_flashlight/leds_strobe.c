...
unsigned int fl_div = CLK_DIV4;
	...
	if (video_mode) {
		printk("XXXXXXXXXXXXXXXXX gpio_FL_Enable video mode gpio 66 mode0 oneXXXXXXXXXXXXXXX\n");
	...
	if (video_mode) {
		printk("XXXXXXXXXXXXXXXXXXXXXX gpio_FL_Disable video mode disableXXXXXXXXXXXXXXXX\n");
		video_mode = 0;
